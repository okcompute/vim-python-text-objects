...
onoremap <buffer> iC :<C-U>call objects#select_inner_class()<CR>

vnoremap <buffer> aC :<C-U>call objects#select_a_class()<CR>
vnoremap <buffer> iC :<C-U>call objects#select_inner_class()<CR>
